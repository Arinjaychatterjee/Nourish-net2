      ...
      <div className={`sm:hidden fixed inset-0 z-50 ${mobileOpen ? '' : 'pointer-events-none'}`}>
        ...
        >
          <div className="p-4 border-b border-neutral-200 flex items-center justify-between">
            ...
            <button onClick={close} className="rounded-lg border border-neutral-200 px-2 py-1 text-sm">Close</button>
          </div>
          <div className="p-2">
            ...
            <div className="p-3 mt-3">
              <a href="/donor" onClick={close} className="inline-flex w-full items-center justify-center rounded-2xl bg-[var(--nb-green)] text-white px-4 py-2 text-sm font-semibold">List a Donation</a>
            </div>
          </div>
        </div>
      </div>
